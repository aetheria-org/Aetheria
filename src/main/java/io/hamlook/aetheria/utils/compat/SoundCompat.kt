...
object SoundCompat {
    ...
    @JvmStatic
    fun getModernSoundName(legacy: String): String =
        soundMap[legacy] ?: legacy

    @JvmStatic
    fun getLegacySoundName(modern: String): String =
        soundMap.entries.firstOrNull { it.value == modern }?.key ?: modern
}
