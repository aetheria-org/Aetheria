package io.hamlook.aetheria.features.qol.enchants;
...
public class EnchantProcessor {
    ...
    private void ensureLoaded() {
        String json = RepoHandler.getJson(ATHRRepo.KEY_ENCHANTS);
    ...
    private class FormattedEnchant implements Comparable<FormattedEnchant> {
        ...
        private String formatted() {
            if (cachedFormatted == null) {
                String lvl = ATHRConfig.feature.qol.romanNumerals ? Integer.toString(level) : toRoman(level);
