...
public class CalcCommand {
    ...
    public void onCommandRegistration(CommandRegistrationEvent event) {
        event.registerBrigadier("athrcalc", builder -> {
            builder.setAliases(Arrays.asList("aetheriacalc", "jefcalc", "asmcalc", "calc"));
            builder.description = "Calculate a math expression";
